document.addEventListener('DOMContentLoaded', function() {
    ...
    fetchDataAndInitializeSlider('j1_creneau_3', 'slider3');
    fetchDataAndInitializeSlider('j1_creneau_4', 'slider4');
    fetchDataAndInitializeSlider('j1_creneau_5', 'slider5');
    fetchDataAndInitializeSlider('j1_creneau_6', 'slider6');
